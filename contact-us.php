...
<head>
        ...
        <title>Peace Tower - Contact </title>
        <!-- Icon css link --> 
        ...
        <div class="animsition">
			...
			<header class="full_header content-white mobile_menu">
        		<div class="float-left">
        			...
        			<a class="phone" href="+234 8188888744"><i class="lnr lnr-phone-handset"></i> +234 8188888744</a>
        		</div>
        	...
        	<section class="project_breadcrumb_area_exterior">
				<div class="container">
					<div class="breadcrumb_inner">
						
						<div class="bread_bottom_text">
							<h2>Peace Tower - Contact Us</h2>
						</div>
					</div>
				</div>
			...
			<section class="contact_area2">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
								<img class="img-fluid" src="asset/img/map-peace-1.jpg" alt="">
